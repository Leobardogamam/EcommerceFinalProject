//
//  CategorieAddRemoteDataManager.swift
//  ProyectoFinal
//
...
class CategorieAddRemoteDataManager:CategorieAddRemoteDataManagerInputProtocol {
  
    
    var remoteRequestHandler: CategorieAddRemoteDataManagerOutputProtocol?
    

    func externalUploadImage(productImage: UIImage) {
        let nombreParametro = "file"
        let nombreArchivo = "categorieImagen.png"
        //Genera y válida URL
    ...
    func externalAddCategorie(name: String, image: String) {
        ...
        guard let objUrl = URL(string: "https://api.escuelajs.co/api/v1/categories") else{return}
